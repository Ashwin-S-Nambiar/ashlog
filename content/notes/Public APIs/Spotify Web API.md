...
## Purpose
This API can be used to show the currently playing songs of a user in their own website, portfolios etc to add a personal touch to it. You can see it in action here [portfolio](https://ashwin.co.in/#footer).