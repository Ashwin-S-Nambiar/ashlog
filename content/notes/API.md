...
APIs can follow patterns like [[notes/REST]] or GraphQL, and are essential in connecting client applications (e.g., [[notes/Tech Stack/React]], [[notes/Tech Stack/Svelte]]) with server-side logic. They are also widely used for third-party services such as [[notes/Open Trivia DB]].  
